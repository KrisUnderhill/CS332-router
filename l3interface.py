...
class L3Interface:
    ...
    def get_directed_bcast_addr(self) -> L3Addr:
        ...
        # bitwise or makes all bits of host part 1, and keeps network part: our whole directed broadcast address
        host_bcast = self._addr.as_int() | host_mask 
    ...
    def on_same_network(self, addr: L3Addr) -> bool:
        ...
        self_network = self._addr.network_part_as_L3Addr(self._mask_numbits)
        other_network = addr.network_part_as_L3Addr(self._mask_numbits)
        return self_network == other_network
